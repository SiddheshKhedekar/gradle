...
public class Jar extends Zip {
    ...
    private static final Function<RelativePath, Boolean> IS_MANIFEST = new Function<RelativePath, Boolean>() {
        ...
        public Boolean apply(RelativePath input) {
            ...
            return segments.length == 2 && IS_META_INF.apply(input) && segments[1].equalsIgnoreCase("MANIFEST.MF");
        }
     ...
     */
    private static final Ordering<RelativePath> JAR_CONTENTS_COMPARATOR =
